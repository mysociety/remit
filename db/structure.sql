...
--
-- Name: publication_types; Type: TABLE; Schema: public; Owner: -; Tablespace:
--
...
CREATE SEQUENCE publication_types_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE publication_types_id_seq OWNED BY publication_types.id;
...
--
-- Name: study_stages; Type: TABLE; Schema: public; Owner: -; Tablespace:
--
...
--
-- Name: study_stages_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE study_stages_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: study_stages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE study_stages_id_seq OWNED BY study_stages.id;
...
ALTER TABLE ONLY publication_types ALTER COLUMN id SET DEFAULT nextval('publication_types_id_seq'::regclass);
...
ALTER TABLE ONLY study_stages ALTER COLUMN id SET DEFAULT nextval('study_stages_id_seq'::regclass);
...
--
-- Name: publication_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY publication_types
...
--
-- Name: study_stages_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY study_stages
...
--
-- Name: index_publication_types_on_name; Type: INDEX; Schema: public; Owner: -; Tablespace:
--

CREATE UNIQUE INDEX index_publication_types_on_name ON publication_types USING btree (name);


--
-- Name: index_publications_on_publication_type_id; Type: INDEX; Schema: public; Owner: -; Tablespace:
--

CREATE INDEX index_publications_on_publication_type_id ON publications USING btree (publication_type_id);
...
--
-- Name: index_studies_on_study_stage_id; Type: INDEX; Schema: public; Owner: -; Tablespace:
--

CREATE INDEX index_studies_on_study_stage_id ON studies USING btree (study_stage_id);
...
--
-- Name: index_study_stages_on_name; Type: INDEX; Schema: public; Owner: -; Tablespace:
--

CREATE UNIQUE INDEX index_study_stages_on_name ON study_stages USING btree (name);
...
--
-- Name: fk_rails_13eb43cd9c; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY studies
    ADD CONSTRAINT fk_rails_13eb43cd9c FOREIGN KEY (study_stage_id) REFERENCES study_stages(id);
...
--
-- Name: fk_rails_bb1ef07276; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY publications
    ADD CONSTRAINT fk_rails_bb1ef07276 FOREIGN KEY (publication_type_id) REFERENCES publication_types(id);
