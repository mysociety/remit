ActiveAdmin.setup do |config|
  ...
  # https://github.com/svenfuchs/i18n/blob/master/lib/i18n/backend/base.rb#L52
  #
  ...
  config.register_javascript "admin_reference_numbers.js"

  # == CSV options
  #
  # Set the CSV builder separator
  config.csv_options = { encoding: Encoding::UTF_8, force_quotes: true }
  #
